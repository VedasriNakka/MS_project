...
epochs=20
hpo_exp_name="Triplet_loss_93_agumentations_$(date +'%Y-%m-%d_%H-%M-%S')"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python src/hpo_v1.py \
        ...
        --hpo_search_space_config "scripts/search_space/search_space_subset_93 _triplet.yaml" $@ >& ./logs/${log_filepath} 

...
epochs=20
hpo_exp_name="CE_loss_resnet18_4_aug_alpub_icdar_seed2_finetune_new_4aug_$(date +'%Y-%m-%d_%H-%M-%S')"
...
CUDA_VISIBLE_DEVICES=0,1,2 python src/hpo_v1.py \
        ...
        --ckpt_path_dict  /home/vedasri/Baseline_V2/results_hpo/final_experiments_v1/CE_loss_resnet18_4_aug_alpub_seed2_sorted_4augs_2024-09-05_15-21-49/config2ckpt_path.json \

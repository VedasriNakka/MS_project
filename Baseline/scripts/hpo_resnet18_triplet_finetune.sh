...
CUDA_VISIBLE_DEVICES=0,1,2,3 python src/hpo_v1.py \
        ...
        --ckpt_path_dict /home/vedasri/Baseline_V2/results_hpo/final_experiments/Triplet_loss_93_agumentations_2024-06-27_20-49-35/config2ckpt_path.json \
        --hpo_search_space_config "scripts/search_space/search_space_subset_93_triplet.yaml" $@ >& ./logs/${log_filepath} 



epochs=20
hpo_exp_name="Triplet_finetine_with_ce_loss_unfreeze_backbone_93_agumentations_$(date +'%Y-%m-%d_%H-%M-%S')"
log_filepath=${hpo_exp_name}.log

...
epochs=20
hpo_exp_name="Triplet_resnet50_alpub_finetine_with_ce_loss_unfreeze_backbone_4_aug_wi_$(date +'%Y-%m-%d_%H-%M-%S')"
...
CUDA_VISIBLE_DEVICES=0,1,2 python src/hpo_v1.py \
        ...
        --ckpt_path_dict /home/vedasri/Baseline_V2/results_hpo/final_experiments_v2/Triplet_resnet50_loss_alpub_4_aug_wi_2024-09-21_10-55-58/config2ckpt_path.json \
...
epochs=20
hpo_exp_name="Triplet_resnet50_alpub_finetine_with_ce_loss_freeze_backbone_4_aug_wi_$(date +'%Y-%m-%d_%H-%M-%S')"
log_filepath=${hpo_exp_name}.log

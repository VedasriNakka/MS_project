...
# epochs=20
# hpo_exp_name="CE_loss_resnet50_4_aug_alpub_icdar_4aug_new_finetune_wi_$(date +'%Y-%m-%d_%H-%M-%S')"
...
#         --ckpt_path_dict /home/vedasri/Baseline_V2/results_hpo/final_experiments_v2/CE_loss_resnet50_4_aug_alpub_wi_2024-09-20_10-39-44/config2ckpt_path.json \
...
epochs=20
hpo_exp_name="CE_loss_resnet50_4_aug_alpub_icdar_4aug_new_finetune_freeze_backbone_wi_$(date +'%Y-%m-%d_%H-%M-%S')"
log_filepath=${hpo_exp_name}.log

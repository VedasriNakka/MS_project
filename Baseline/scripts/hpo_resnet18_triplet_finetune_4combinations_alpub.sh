...
epochs=20
hpo_exp_name="Triplet_alpub_finetine_with_ce_loss_unfreeze_backbone_4_agumentations_$(date +'%Y-%m-%d_%H-%M-%S')"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python src/hpo_v1.py \
        ...
        --ckpt_path_dict /home/vedasri/Baseline_V2/results_hpo/final_experiments/Triplet_loss_alpub_4_agumentations_resnet18_2024-07-25_19-26-32/config2ckpt_path.json \
...
epochs=20
hpo_exp_name="Triplet_alpub_finetine_with_ce_loss_freeze_backbone_4_agumentations_$(date +'%Y-%m-%d_%H-%M-%S')"
log_filepath=${hpo_exp_name}.log

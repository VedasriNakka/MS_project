...
epochs=20
hpo_exp_name="SimCLR_finetine_with_ce_loss_unfreeze_backbone_93_agumentations_$(date +'%Y-%m-%d_%H-%M-%S')"
...
epochs=20
hpo_exp_name="SimCLR_finetine_with_ce_loss_freeze_backbone_93_agumentations_$(date +'%Y-%m-%d_%H-%M-%S')"
log_filepath=${hpo_exp_name}.log

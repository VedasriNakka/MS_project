...
logging.basicConfig(filename=f'./src/aug_ttest_result/baseline_CE_augmentation_test_v1_{current_time}.log', level=logging.INFO, 
...
logging.info("Top-4 Augmentation results: \n")
# Print results

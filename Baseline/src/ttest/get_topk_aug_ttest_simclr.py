...
logging.basicConfig(filename=f'./src/aug_ttest_result/baseline_simclr_augmentation_ttest_{current_time}.log', level=logging.INFO, 
...
#logging.info(top_4_augmentations)

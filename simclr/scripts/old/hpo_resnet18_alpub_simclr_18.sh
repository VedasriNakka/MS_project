...
hpo_exp_name="resize96_alpub_simclr_4combinations"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python src/hpo_v2.py \
        ...
        --gpu_per_worker 1.0 \
        --cpu_per_worker 2 \
        --hpo_search_space_config "scripts/search_space/search_space_resnet18_alpub_simclr_18.yaml" $@ >& ./logs/${log_filepath}
